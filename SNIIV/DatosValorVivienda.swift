...
class DatosValorVivienda {
    ...
    func consultaNacional() -> ValorVivienda {
        ...
        var economica: Int64 = datos.map{ return $0.economica }.reduce(0) {$0 + $1}
        datoEntidad.economica = economica
        
        var popular: Int64 = datos.map{ return $0.popular }.reduce(0) {$0 + $1}
        datoEntidad.popular = popular
        
        var tradicional: Int64 = datos.map{ return $0.tradicional }.reduce(0) {$0 + $1}
        datoEntidad.tradicional = tradicional
        
        var media_residencial: Int64 = datos.map{ return $0.media_residencial }.reduce(0) {$0 + $1}
